...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun', 'Manual']}>
  ...
  <Tab value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://hacomponents.keshuac.com/r/camera.json
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn shadcn@latest add https://hacomponents.keshuac.com/r/camera.json
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bunx --bun shadcn@latest add https://hacomponents.keshuac.com/r/camera.json
    ```
  </Tab>
  <Tab value="Manual">
      TODO COMPLETE ME
...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun', 'Manual']}>
  ...
  <Tab value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://hacomponents.keshuac.com/r/proxy.json
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn shadcn@latest add https://hacomponents.keshuac.com/r/proxy.json
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bunx --bun shadcn@latest add https://hacomponents.keshuac.com/r/proxy.json
    ```
  </Tab>
  <Tab value="Manual">
      TODO COMPLETE ME
